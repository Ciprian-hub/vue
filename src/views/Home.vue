<template>
  <div class="mx-auto max-w-7xl sm:px-6 lg:px-8 bg-white">
    <div class="flex justify-between py-3 items-center border-b-2">
      <div class="h-10 w-full">
        <svg class="" width="58" height="58" viewBox="0 0 58 58" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <div>
      <h1 class="mx-auto text-center text-2xl py-16">
